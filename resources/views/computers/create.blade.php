                    ...
                    <form action="{{ route('computer.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="emp_code" class="block mt-1 w-full" type="text" name="emp_code" :value="old('emp_code')" required autocomplete="emp_code" />
                            ...
                            <div>
                                ...
                                <x-text-input id="device_model" class="block mt-1 w-full" type="text" name="device_model" :value="old('device_model')" autocomplete="device_model" />
                            ...
                            <div>
                                ...
                                <x-text-input id="cpu" class="block mt-1 w-full" type="text" name="cpu" :value="old('cpu')" autocomplete="cpu" />
                            ...
                            <div>
                                ...
                                <x-text-input id="hard_disk" class="block mt-1 w-full" type="text" name="hard_disk" :value="old('hard_disk')" autocomplete="hard_disk" />
                            ...
                            <div>
                                ...
                                <x-text-input id="ram" class="block mt-1 w-full" type="text" name="ram" :value="old('ram')" autocomplete="ram" />
                            ...
                            <div>
                                ...
                                <x-text-input id="monitor" class="block mt-1 w-full" type="text" name="monitor" :value="old('monitor')" autocomplete="monitor" />
                            ...
                            <div>
                                ...
                                <x-text-input id="os" class="block mt-1 w-full" type="text" name="os" :value="old('os')" autocomplete="os" />
                            ...
                            <div>
                                ...
                                <x-text-input id="office_version" class="block mt-1 w-full" type="text" name="office_version" :value="old('office_version')" autocomplete="office_version" />
                            ...
                            <div>
                                ...
                                <x-text-input id="mail_client" class="block mt-1 w-full" type="text" name="mail_client" :value="old('mail_client')" autocomplete="mail_client" />
                            ...
                            <div>
                                ...
                                <x-text-input id="mac_address" class="block mt-1 w-full" type="text" name="mac_address" :value="old('mac_address')" autocomplete="mac_address" />
